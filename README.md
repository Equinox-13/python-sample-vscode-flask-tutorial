[![Build Status](https://dev.azure.com/quaidjohar33/eShopOnWeb/_apis/build/status%2FEquinox-13.python-sample-vscode-flask-tutorial?branchName=main)](https://dev.azure.com/quaidjohar33/eShopOnWeb/_build/latest?definitionId=2&branchName=main)
